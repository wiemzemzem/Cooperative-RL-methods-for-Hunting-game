...
import simbad.gui.WorldControlGUI;
 ...
 * @author Louis Hugues
 */
public class MyControlWindow extends JInternalFrame {

	private static final long serialVersionUID = 1L;
       MyEnv ev;


	public MyControlWindow(MyEnv env ,World world,  Simulator simulator){
    	    super("MyControl");
    	...
    	private void createGui(World world,Simulator simulator){
       	...
       	panel.add(new MySimulatorControlGUI(ev,(JFrame)getParent(),simulator));
    	    pack();
    	}
}

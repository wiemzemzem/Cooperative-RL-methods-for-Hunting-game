 ...
 *  
 */
public class MySimbad extends JFrame implements ActionListener {
    ...
    MyControlWindow controlWindow=null;
    WorldParametersGUI parameterWindow=null;
    ...
    public MySimbad(MyEnv envr, EnvironmentDescription ed,boolean backgroundMode) {
    ...
    private void start(EnvironmentDescription ed){
       ...
       // simulator.setVirtualTimeFactor(50);
    ...
    private void createInternalFrames() {
        ...
        if (!backgroundMode){
        controlWindow = new MyControlWindow(env,world, simulator);
        desktop.add(controlWindow);
        controlWindow.show();
        controlWindow.setLocation(300, 450);
        
        parameterWindow = new WorldParametersGUI(env,world,simulator);
        desktop.add(parameterWindow);
        parameterWindow.show();
        parameterWindow.setLocation(20, 320);
        
        
        
        /////////////
        fenetre = new Fenetre(env);
                desktop.add(fenetre);
                fenetre.show();
                fenetre.setLocation(750, 0);
        }
    }
     public void createFenetre(MyEnv env) {
      /*   fenetre = new Fenetre(env);
                desktop.add(fenetre);
                fenetre.show();
                fenetre.setLocation(750, 0);

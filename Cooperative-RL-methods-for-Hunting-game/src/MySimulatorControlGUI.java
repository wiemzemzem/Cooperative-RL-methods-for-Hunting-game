 ...
 */
public class MySimulatorControlGUI extends JPanel implements ActionListener {
    ...
    public MySimulatorControlGUI(MyEnv envOutputs, JFrame parentFrame, Simulator simulator) {
        this.simulator = simulator;
        this.myenv = envOutputs;
    ...
    void createGUI() {
        ...
        createRadioButton(panel2, bgroup, "50.0", "tf50.0", false);
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (action.equals("run")) {
          ...
          //  myenv.outputsList.add("hello world");
            //while (!myenv.outputsList.isEmpty())
            System.out.println( "size outputsList="+myenv.outputsList.size());

            
            /*try {
                //file 
                PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(new File("outputs.txt"), true)));

                while (!myenv.outputsList.isEmpty()) {
                    pw.println(myenv.outputsList.remove(0).toString());
                }
            ...
            simulator.setVirtualTimeFactor(0.04f);
